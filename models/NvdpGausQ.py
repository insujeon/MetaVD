...
class NvdpGausQ(BaseModel):
    def __init__(self, args, num_classes):
        ...
        # args.exp = f'_{args.algorithm}_(_ilr:{args.inner_lr}_beta:{args.beta}_d1:{args.decay1}_abs:{args.adaptation_bs})'+f'_{args.uuid}'
        # args.exp = f'_{args.algorithm}_(_ilr:{args.inner_lr}_ad_epoch:{args.adaptation_epochs}_ad_steps{args.adaptation_steps}_beta:{args.beta}_mom1:{args.momentum1}_mom2:{args.momentum2})'+f'_{args.uuid}'
