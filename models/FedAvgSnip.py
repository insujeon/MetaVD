...
class FedAvgSnip(BaseModel):
    ...
    def client_update(self, ldr_train, wt, w_local=None):
        ...
        for images, labels in ldr_train:
            ...
            wt = [w - self.args.inner_lr * g * self.hpnet.mask[i] if i in self.hpnet.droplayer else w - self.args.inner_lr * g for i, (w, g) in enumerate(zip(wt, grad))]
